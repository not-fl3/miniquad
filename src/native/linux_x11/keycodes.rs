...
pub unsafe fn translate_key(libx11: &mut LibX11, display: *mut Display, scancode: i32) -> KeyCode {
	...
	let keysyms = (libx11.XGetKeyboardMapping)(display, scancode as _, 1 as libc::c_int, &mut dummy);
...
pub unsafe extern "C" fn keysym_to_unicode(keysym: super::libx11::KeySym) -> i32 {
	...
	let mut mid;
	if (keysym >= 0x20 as libc::c_int as libc::c_ulong && keysym <= 0x7e as libc::c_int as libc::c_ulong) || (keysym >= 0xa0 as libc::c_int as libc::c_ulong && keysym <= 0xff as libc::c_int as libc::c_ulong) {
		return keysym as i32;
	}
	if keysym & 0xff000000 as libc::c_uint as libc::c_ulong == 0x1000000 as libc::c_int as libc::c_ulong {
