...
pub unsafe fn create_empty_cursor(display: *mut Display, root: Window, libx11: &mut LibX11) -> Cursor {
	...
	let cursor_pixmap = (libx11.XCreateBitmapFromData)(display, root, cursor_color_data.as_mut_ptr(), 1 as libc::c_int as libc::c_uint, 1 as libc::c_int as libc::c_uint);
