...
pub mod Xlib_h {
	...
	pub type XErrorHandler = Option<unsafe extern "C" fn(_: *mut Display, _: *mut XErrorEvent) -> libc::c_int>;
	#[derive(Copy, Clone)]
	#[repr(C)]
...
pub type Xutf8SetWMProperties =
	unsafe extern "C" fn(_: *mut Display, _: Window, _: *const libc::c_char, _: *const libc::c_char, _: *mut *mut libc::c_char, _: libc::c_int, _: *mut XSizeHints, _: *mut XWMHints, _: *mut XClassHint);
pub type XLookupString = unsafe extern "C" fn(_: *mut XKeyEvent, _: *mut libc::c_char, _: libc::c_int, _: *mut KeySym, _: *mut XComposeStatus) -> libc::c_int;
...
pub type XInternAtom = unsafe extern "C" fn(_: *mut Display, _: *const libc::c_char, _: libc::c_int) -> Atom;
pub type XCreateColormap = unsafe extern "C" fn(_: *mut Display, _: Window, _: *mut Visual, _: libc::c_int) -> Colormap;
...
pub type XSetWMProtocols = unsafe extern "C" fn(_: *mut Display, _: Window, _: *mut Atom, _: libc::c_int) -> libc::c_int;
pub type XChangeProperty = unsafe extern "C" fn(_: *mut Display, _: Window, _: Atom, _: Atom, _: libc::c_int, _: libc::c_int, _: *const libc::c_uchar, _: libc::c_int) -> libc::c_int;
...
pub type XGetWindowAttributes = unsafe extern "C" fn(_: *mut Display, _: Window, _: *mut XWindowAttributes) -> libc::c_int;
...
pub type XResizeWindow = unsafe extern "C" fn(_: *mut Display, _: Window, _: libc::c_int, _: libc::c_int) -> libc::c_int;
...
pub type XGetKeyboardMapping = unsafe extern "C" fn(_: *mut Display, _: KeyCode, _: libc::c_int, _: *mut libc::c_int) -> *mut KeySym;
...
pub type XGrabPointer = unsafe extern "C" fn(_: *mut Display, _: Window, _: libc::c_int, _: libc::c_uint, _: libc::c_int, _: libc::c_int, _: Window, _: Cursor, _: Time) -> libc::c_int;
pub type XUngrabPointer = unsafe extern "C" fn(_: *mut Display, _: Time) -> libc::c_int;
pub type XSendEvent = unsafe extern "C" fn(_: *mut Display, _: Window, _: libc::c_int, _: libc::c_long, _: *mut XEvent) -> libc::c_int;
pub type XrmGetResource = unsafe extern "C" fn(_: XrmDatabase, _: *const libc::c_char, _: *const libc::c_char, _: *mut *mut libc::c_char, _: *mut XrmValue) -> libc::c_int;
...
pub type XkbSetDetectableAutoRepeat = unsafe extern "C" fn(_: *mut Display, _: libc::c_int, _: *mut libc::c_int) -> libc::c_int;
pub type XQueryExtension = unsafe extern "C" fn(_: *mut Display, _: *const libc::c_char, _: *mut libc::c_int, _: *mut libc::c_int, _: *mut libc::c_int) -> libc::c_int;
pub type XConvertSelection = unsafe extern "C" fn(_: *mut Display, _: Atom, _: Atom, _: Atom, _: Window, _: Time) -> libc::c_int;
pub type XSetSelectionOwner = unsafe extern "C" fn(_: *mut Display, _: Atom, _: Window, _: Time) -> libc::c_int;
...
pub type XCreateBitmapFromData = unsafe extern "C" fn(_: *mut Display, _: Drawable, _: *const libc::c_char, _: libc::c_uint, _: libc::c_uint) -> Pixmap;
pub type XCreatePixmapCursor = unsafe extern "C" fn(_: *mut Display, _: Pixmap, _: Pixmap, _: *mut XColor, _: *mut XColor, _: libc::c_uint, _: libc::c_uint) -> Cursor;
...
impl LibX11 {
	pub fn try_load() -> Option<LibX11> {
		crate::native::module::Module::load("libX11.so")
			...
			.map(|module| LibX11 {
				...
				XkbSetDetectableAutoRepeat: module.get_symbol("XkbSetDetectableAutoRepeat").unwrap(),
	...
	pub unsafe fn load_extensions(&mut self, display: *mut Display) {
		self.extensions = X11Extensions {
			utf8_string: (self.XInternAtom)(display, b"UTF8_STRING\x00" as *const u8 as *const libc::c_char, false as _),
			wm_protocols: (self.XInternAtom)(display, b"WM_PROTOCOLS\x00" as *const u8 as *const libc::c_char, false as _),
			wm_delete_window: (self.XInternAtom)(display, b"WM_DELETE_WINDOW\x00" as *const u8 as *const libc::c_char, false as _),
			_wm_state: (self.XInternAtom)(display, b"WM_STATE\x00" as *const u8 as *const libc::c_char, false as _),
			net_wm_name: (self.XInternAtom)(display, b"_NET_WM_NAME\x00" as *const u8 as *const libc::c_char, false as _),
			net_wm_icon_name: (self.XInternAtom)(display, b"_NET_WM_ICON_NAME\x00" as *const u8 as *const libc::c_char, false as _),
		};
	}
}
